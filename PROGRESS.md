...
**已完成（续）**：spine09/10 评审＋修复（2026-07-14，同批评）——两卡 4 名评审员 + 2 名对抗复核 agent。spine09：3 高（英伟达六年跨度 13pt→18pt 链式污染 6+ 处、FY21 表格 65%→62%、FY25 PP&E "不到 60 亿"→约 63 亿）+ 8 中/低（DRAM 一体化"物理约束"过硬软化、"几千亿个电容"改"几百亿"、博通 AI 122 亿含网络产品补注、Cyrix/3dfx "实力相当"改精确、"几次濒临破产"改"1996-97 一次"、FY23 深跌归因改"加密崩+库存冲销"非 AMD 追平、台积电波动小归因补 pricing power、HBM 40%+ 改"4Q24 单季"、通富微电加来源徽章、TPU 措辞改博通 backend）。复核推翻 1 例：「+18 vs +49 差 3 倍」指控不成立（保留原文）。spine10：3 高（AXT 2022/2023 数字 $135/75.5→$141.1/75.8、CoWoS 2023 20K→13K 三处联动、SEMI 2023 转正→2024 转正）+ 10 中（billings vs orders 通篇改"设备出货"、AXT Q4 收窄→全年、FY26 88%→90%、Nvidia 公告日期 02-26→02-25、味之素徽章改二手转述、博通 SEC 分部披露口径修、AXT 领先 3-4 季改专家判断+推论、EUV €227M/台改估算、云 CapEx 徽章标二手汇总、SVG 图注补口径说明——自然年 vs Nvidia 财年错位、CoWoS 中位数、观察窗口起点）。模型层反例（甲 10 报"信号硬度 vs 前瞻性反向"适用边界未清）按用户指令暂缓，纳入结论层专项重审待办。
